...
public class CommentRestController {
	...
	public ResponseEntity<Map> comment_list(@RequestParam("cno")int cno,Model model,@RequestParam("type")int type)
	{
		Map map=new HashMap();
		try
		{
	...
	public ResponseEntity<Map> comment_delete(@RequestParam("cno")int cno,@RequestParam("no")int no,@RequestParam("type")int type,Model model)
	{
		Map map=new HashMap();
		try
		{
	...
	public ResponseEntity<Map> comment_update(@RequestParam("cno")int cno,@RequestParam("no")int no,@RequestParam("type")int type,@RequestParam("msg")String msg)
	{
		Map map=new HashMap();
		try
		{
